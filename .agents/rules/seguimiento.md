...
6. *SEGUIMIENTO*: SIEMPRE Cada 20 iteraciones, generar una copia de toda la conversacion usaurio/IA en un archivo de la razon del proyecto de tipo markdown llamado backupIA.md en raiz del proyecto en formato comprimido para IA. este archivo servira de base para siempre tener el contexto de lo que se ha realizado en todo el proyecto.